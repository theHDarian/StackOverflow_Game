...
const RoomPreset EnemyRoomSnailsHard {
            {
                ...
                {
                        {EnemyType::EnemyEvilSnail, {random_pos, random_pos}},
{EnemySnail, {random_pos, random_pos}},
...
const RoomPreset EnemyRoomBees2{
        {
            ...
            {EnemyType::EnemyBeeHive, {0.8f, 0.4f}}},
            {
                {EnemyType::EnemyTwoBee, {random_pos, random_pos}},
                   {EnemyEvilSnail, {random_pos, random_pos}},
                 {EnemyType::EnemyTwoBee, {random_pos, random_pos}},
        {EnemyType::EnemyTwoBee, {random_pos, random_pos}},
...
const RoomPreset EnemyRoomMagic{
        {
            ...
            {
                {EnemyType::EnemyScissors, {random_pos, random_pos}},
                {EnemyType::EnemySword, {random_pos, random_pos}},
                    {EnemyType::EnemyHealer, {random_pos, random_pos}},
                {EnemyType::EnemyHealer, {random_pos, random_pos}},
            },
...
const RoomPreset BossRoomMole {
        {
                ...
                {
                    {EnemyDynamite, {random_pos, random_pos}},
                    {EnemyDynamite, {random_pos, random_pos}},

            {EnemyDynamite, {random_pos, random_pos}},
                {EnemyDynamite, {random_pos, random_pos}},{EnemyDynamite, {random_pos, random_pos}},
                {EnemyDynamite, {random_pos, random_pos}},{EnemyDynamite, {random_pos, random_pos}},
                {EnemyDynamite, {random_pos, random_pos}},{EnemyDynamite, {random_pos, random_pos}},
                {EnemyDynamite, {random_pos, random_pos}},{EnemyDynamite, {random_pos, random_pos}},
                {EnemyDynamite, {random_pos, random_pos}},{EnemyDynamite, {random_pos, random_pos}},
    ...
    {
        {
            ...
            {EnemyMagnet,{random_pos, random_pos}},
            {EnemyMagnet,{random_pos, random_pos}}
        },
        {
            {EnemyScissors, {0.5f, 0.5f}},
            {EnemyScissors,{random_pos, random_pos}},
            {EnemyScissors,{random_pos, random_pos}}
        },
            {
                {EnemySword, {0.5f, 0.5f}},
                {EnemySword,{random_pos, random_pos}},
                {EnemySword,{random_pos, random_pos}}
            },
        {
            {EnemyMedicalRodA, {0.5f, 0.5f}},
            {EnemyMedicalRodA,{random_pos, random_pos}},
            {EnemyMedicalRodA,{random_pos, random_pos}}
        },
    },
    {},
...
//             { EnemyMedicalSyringe, {0.4f, 0.8f}},
            {EnemyMedicalBoid, {random_pos, random_pos}},
                {EnemyMedicalBoid, {random_pos, random_pos}},
{EnemyMedicalBoid, {random_pos, random_pos}},
{EnemyMedicalBoid, {random_pos, random_pos}},
{EnemyMedicalBoid, {random_pos, random_pos}},
...
const RoomPreset MiningEnemyRoomMineField {
        {
                {
                { EnemySurfaceMole, {random_pos, random_pos}},
            ...
            {EnemyDynamite, {random_pos, random_pos}},
                ...
                {EnemyDynamite, {random_pos, random_pos}},{EnemyDynamite, {random_pos, random_pos}},
                    ...
                    {EnemyDynamite, {random_pos, random_pos}},{EnemyDynamite, {random_pos, random_pos}},
                                    {EnemyDynamite, {random_pos, random_pos}},
                { EnemySmallMole, {random_pos, random_pos}},
                { EnemySmallMole, {random_pos, random_pos}},
                },
                ...
                {EnemyDynamite, {random_pos, random_pos}},
                    ...
                    {EnemyDynamite, {random_pos, random_pos}},{EnemyDynamite, {random_pos, random_pos}},
                        ...
                        {EnemyDynamite, {random_pos, random_pos}},{EnemyDynamite, {random_pos, random_pos}},
                                        {EnemyDynamite, {random_pos, random_pos}},
                    { EnemySmallBoulder, {random_pos, random_pos}},
                    { EnemySmallBoulder, {random_pos, random_pos}},
                        { EnemySmallBoulder, {random_pos, random_pos}},
                                        { EnemySmallBoulder, {random_pos, random_pos}},
                        { EnemySmallBoulder, {random_pos, random_pos}},
...
const RoomPreset allConsoles {
    { {
        {EnemyMedicalBMP, {random_pos, random_pos}},
// {EnemyScissors, {random_pos, random_pos}},
{EnemyScissors, {random_pos, random_pos}},
{EnemyMedicalRodC, {random_pos, random_pos}},
// {EnemyMedicalPillBoid, {random_pos, random_pos}},
// {EnemyMedicalPillBoid, {random_pos, random_pos}},
// {EnemyMedicalPillBoid, {random_pos, random_pos}},
// {EnemyMedicalPillBoid, {random_pos, random_pos}},
{EnemyMedicalPillBoidSpawner, {random_pos, random_pos}},
    ...
    {DifficultyRegion::Easy,{
        {
            ...
            {
                {
                    EnemyRoomSingleMage, QuadShooterRoomSmall, MiningEnemyRoomBoulders
                },
