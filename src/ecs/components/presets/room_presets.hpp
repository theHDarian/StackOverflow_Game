...
{EnemyType::EnemyBioBoid, random_vec2},
{EnemyType::EnemyBioBoid, random_vec2},
{EnemyType::EnemyOneBee, random_vec2},
{EnemyType::EnemyOneBee, random_vec2},
{EnemyType::EnemyOneBee, random_vec2},
{EnemyType::EnemyOneBee, random_vec2},
{EnemyType::EnemyOneBee, random_vec2},
...
const RoomPreset TreasureRoomRisky{
        {},
        {},
        {{{FightConsole,{homingUp, dmgDown,dmgDown,dmgDown,numBulletsDown,numBulletsDown,numBulletsDown,fireRateDown,fireRateDown,fireRateDown,bulletBurstDown,bulletBurstDown,bulletBurstDown}}, {0.5f, 0.5f}}},
        0.0f,
        5,
        0,
        "Risky Business",
