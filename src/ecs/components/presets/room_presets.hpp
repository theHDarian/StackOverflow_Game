...
const RoomPreset EnemyRoomBees1{
    {{EnemyType::HardEnemyBoid, {0.6f, 0.5f}},
     {EnemyType::HardEnemyBoid, {0.8f, 0.1f}},
     {EnemyType::HardEnemyBoid, {0.5f, 0.5f}},
     {EnemyType::HardEnemyBoid, {0.2f, 0.2f}},
     {EnemyType::HardEnemyBoid, {0.4f, 0.6f}},
     {EnemyType::HardEnemyBoid, {0.3f, 0.7f}},
     {EnemyType::HardEnemyBoid, {0.1f, 0.2f}},
     {EnemyType::HardEnemyBoid, {0.2f, 0.1f}},
     {EnemyType::HardEnemyBoid, {0.9f, 0.9f}},
     {EnemyType::HardEnemyBoid, {0.9f, 0.6f}},
     {EnemyType::HardEnemyBoid, {0.2f, 0.4f}},
     {EnemyType::HardEnemyBoid, {0.3f, 0.6f}},{EnemyType::HardEnemyBoid, {0.6f, 0.5f}},
     {EnemyType::HardEnemyBoid, {0.8f, 0.1f}},
     {EnemyType::HardEnemyBoid, {0.5f, 0.5f}},
     {EnemyType::HardEnemyBoid, {0.2f, 0.2f}},
     {EnemyType::HardEnemyBoid, {0.4f, 0.6f}},
     ...
     {EnemyType::HardEnemyBoid, {0.9f, 0.6f}},
     {EnemyType::HardEnemyBoid, {0.2f, 0.4f}},
     {EnemyType::HardEnemyBoid, {0.3f, 0.6f}}},
    {},
    {},
    {},
    5.0f,
