...
const RoomPreset BioEnemyRoomSwarm{
    {
        {
            {EnemyType::EnemyBioBoid, random_batch},
            {EnemyType::EnemyBioBoid, random_batch},
            {EnemyType::EnemyBioBoid, random_batch},
            {EnemyType::EnemyBioBoid, random_batch},
            {EnemyType::EnemyBioBoid, random_batch},
...
const RoomPreset RestingRoom3PopLarge{
    ...
    {},
    {
        {{PopConsole, {}}, {0.5f, 0.5f}}, {{PopConsole, {}}, {0.25f, 0.5f}}, {{PopConsole, {}}, {0.75f, 0.5f}},
        {{PushConsole, {bulletPierceUp, bulletRangeUp}}, {0.5f, 0.25f}},
        {{PopConsole, {dashUp, dashRechargeUp}}, {0.5f, 0.75f}}
    },
    0.0f,
    0,
    0,
...
const RoomPreset TreasureRoomChoice3{
    ...
    {},
    {
        {{FightConsole, {bulletPierceUp, bulletPierceUp,}}, {0.4f, 0.5f}},
        {{FightConsole, {bulletBounceUp, bulletBounceUp}}, {0.6f, 0.5f}}
    },
    0.0f,
    5,
    0,
    "Treasure Room Choice 3",
    false,
    {2000, 1500},
};
...
const RoomPreset TreasureRoomChoice4{
    ...
    {},
    {
        {{FightConsole, {bulletRangeUp, bulletRangeUp,}}, {0.4f, 0.5f}},
        {{FightConsole, {accuracyUp, accuracyUp, accuracyUp,}}, {0.6f, 0.5f}}
    },
    0.0f,
    5,
    0,
    "Treasure Room Choice 4",
    false,
    {2000, 1500},
};
...
const RoomPreset TreasureRoomChoice5{
    ...
    {},
    {
        {{FightConsole, {dashRechargeUp, dashRechargeUp,}}, {0.4f, 0.5f}},
        {{FightConsole, {dashUp, dashUp, dashUp}}, {0.6f, 0.5f}}
    },
    0.0f,
    5,
    0,
    "Treasure Room Choice 5",
    false,
    {2000, 1500},
};
...
const RoomPreset TreasureRoomChoice6{
    ...
    {},
    {
        {{FightConsole, {playerSpeedUp, playerSpeedUp,}}, {0.4f, 0.5f}},
        {{FightConsole, {bulletRangeUp, bulletRangeUp,}}, {0.6f, 0.5f}}
    },
    0.0f,
    5,
    0,
    "Treasure Room Choice 6",
    false,
    {2000, 1500},
};
...
const RoomPreset TreasureRoomChoice7{
    ...
    {},
    {
        {{FightConsole, {dashRechargeUp, dashRechargeUp, dashRechargeUp, dashDown}}, {0.4f, 0.5f}},
        {{FightConsole, {bulletRangeUp, bulletRangeUp, bulletRangeUp, bulletRangeDown}}, {0.6f, 0.5f}}
    },
    0.0f,
    5,
    0,
    "Treasure Room Choice 7",
    false,
    {2000, 1500},
};
...
const RoomPreset TreasureRoomChoice8{
    ...
    {},
    {
        {{FightConsole, {fireRateUp, fireRateUp, dmgDown, dmgDown, bulletRangeDown, bulletRangeDown}}, {0.4f, 0.5f}},
        {{FightConsole, {homingUp, dmgDown, dmgDown, accuracyDown, accuracyDown}}, {0.6f, 0.5f}}
    },
    0.0f,
    5,
    0,
    "Treasure Room Choice 8",
    false,
    {2000, 1500},
};
        ...
        {
            {
                PushConsole,
                {
                    dmgUp, dmgUp, dmgUp, bulletRangeUp, bulletRangeUp, bulletRangeUp, playerSpeedDown, playerSpeedDown,
                    playerSpeedDown
                }
            },
            {0.5f, 0.5f}
        ...
        {
            {
                PushConsole,
                {
                    bulletRangeDown, bulletRangeDown, bulletRangeDown, accuracyDown, accuracyDown, accuracyDown,
                    numBulletsUp, numBulletsUp, numBulletsUp,
                }
            },
            {0.5f, 0.5f}
        }
        ...
        {
            {
                PushConsole,
                {
                    dashDown, dashDown, dashDown, dashRechargeDown, dashRechargeDown, dashRechargeDown, playerSpeedUp,
        ...
        {
            {
                PushConsole,
                {
                    fireRateUp, fireRateUp, fireRateUp, dmgDown, dmgDown, dmgDown, numBulletsDown, numBulletsDown,
                    numBulletsDown
                }
            },
            {0.5f, 0.5f}
        ...
        {
            {
                PushConsole,
                {
                    sizeUp, sizeUp, sizeUp, bulletPierceUp, bulletPierceUp, bulletPierceUp, bulletRangeDown,
                    bulletRangeDown
                }
            },
            {0.5f, 0.5f}
        ...
        {
            {
                PushConsole,
                {
                    playerSpeedDown, playerSpeedDown, playerSpeedDown, playerSpeedDown, playerSpeedDown,
                    playerSpeedDown, dashRechargeUp, dashRechargeUp, dashRechargeUp, dashUp, dashUp, dashUp
                }
            },
            {0.5f, 0.5f}
        }
        ...
        {
            {
                FightConsole,
                {
                    homingUp, dmgDown, dmgDown, dmgDown, numBulletsDown, numBulletsDown, numBulletsDown, fireRateDown,
...
const RoomPreset TreasureRoomKeys{
    ...
    {},
    {
        {{PushConsole, {key}}, {0.5f, 0.5f}}, {{PushConsole, {key}}, {0.25f, 0.5f}},
        {{PushConsole, {key}}, {0.75f, 0.5f}}
    },
    0.0f,
    5,
    0,
...
const RoomPreset HifiRoomBoidSnipers{
    {
        ...
        {
            {EnemyType::EnemyHifiBoid, random_batch},
            {EnemyType::EnemyHifiBoid, random_batch},
            {EnemyType::EnemyHifiBoid, random_batch},
            {EnemyType::EnemyHifiBoid, random_batch},
            {EnemyType::EnemyHifiBoid, random_batch},
...
const RoomPreset HifiRoomLaserFiesta{
    ...
    {
        {
            {PushConsole, {fireRateUp, fireRateUp, fireRateUp, bulletRangeUp, bulletRangeUp, bulletRangeUp}},
            {0.25f, 0.5f}
        },
        {{PopConsole, {}}, {0.75f, 0.5f}},
    },
...
const RoomPreset MedicalRoomQuadShooter{
    ...
    {},
    {
        {{PushConsole, {bulletBounceUp, bulletBounceUp, bulletRangeUp, bulletRangeUp}}, {0.3f, 0.5f}},
        {{PushConsole, {bulletPierceUp, bulletPierceUp, bulletPierceUp}}, {0.7f, 0.5f}},
        {{PopConsole, {}}, {0.5f, 0.5f}}
    },
    20.0f,
    25,
...
const RoomPreset MiningEnemyRoomMineField{
    ...
    {},
    {
        {{PushConsole, {sizeUp3, bulletBounceUp, bulletBounceUp, bulletBounceUp}}, {0.4f, 0.5f}},
        {{PopConsole, {}}, {0.6f, 0.5f}}
    },
    10.0f,
    25,
    5,
    ...
    {
        {
            ...
            {EnemySmallMiningWormHead, {1.12f, random_float}},
            {EnemySmallMiningWormHead, {-1.12f, random_float}},
            {EnemyMiningBoidWormHead, random_batch}, {EnemyMiningBoidWormHead, random_batch},
            {EnemyMiningBoidWormHead, random_batch}, {EnemyMiningBoidWormHead, random_batch},
            {EnemyMiningBoidWormHead, random_batch}, {EnemyMiningBoidWormHead, random_batch},
            {EnemyMiningBoidWormHead, random_batch}, {EnemyMiningBoidWormHead, random_batch},
            {EnemyMiningBoidWormHead, random_batch},
        },
        {
            {EnemySmallMiningWormHead, {1.12f, random_float}},
            {EnemySmallMiningWormHead, {random_float, -1.12f}},
...
const std::vector<RoomPreset> choiceTreasureRooms = {
    TreasureRoomChoice1, TreasureRoomChoice2, TreasureRoomChoice3, TreasureRoomChoice4, TreasureRoomChoice5,
    TreasureRoomChoice6, TreasureRoomChoice7, TreasureRoomChoice8,
};
        ...
        DifficultyRegion::Easy, {
            {
                ...
                {
                    {
                        EnemyRoomBees1, EnemyRoomDash1, EnemyRoomCrabs, BioRoomSmall, EnemyRoomBees2, EnemyRoomBees3,
                        EnemyRoomDash2, EnemyRoomSnails
                    },
                    {EnemyRoomInvisible, BioEnemyRoomSwarm}
                }
            },
            {
                RoomType::RestRoom,
        ...
        DifficultyRegion::Medium, {
            {
                ...
                {
                    {
                        EnemyRoomAngelTank, EnemyRoomCrabs, EnemyRoomDashHard, EnemyRoomBees3, EnemyRoomDash2,
                        EnemyRoomBees2, BioEnemyRoomDogs
                    },
                    {EnemyRoomInvisible}
                }
            },
...
std::map<DifficultyRegion, std::map<RoomType, RoomPresets> > physicsRoomDirectory = {
    {
        DifficultyRegion::Intro, {
            ...
            {
                RoomType::EventRoom,
                {{EventRoomWish, EventRoomOracleCrab, EventRoomSwarm}, {EventRoomBaru, EventRoomWish}}
            },
            {
                RoomType::TreasureRoom,
                {
    ...
    },
    {
        DifficultyRegion::Easy, {
                ...
                {
                    {
                        ...
                        HifiRoomSniperShurikens, HifiRoomCannonBoids, HifiRoomSmall, HifiRoomAvenue, HifiRoomLane,
                        HifiRoomSmallTackShooter
                    },
            ...
            {
                RoomType::EventRoom,
                {{EventRoomWish, EventRoomSwarm, EventRoomOracleCrab,}, {EventRoomBaru, EventRoomWish}}
            },
            {
                RoomType::TreasureRoom,
                {
    ...
    },
    {
        DifficultyRegion::Medium, {
            ...
            {
                RoomType::EventRoom,
                {{EventRoomBaru, EventRoomWish, EventRoomOracleCrab, EventRoomSwarm}, {EventRoomBaru, EventRoomWish}}
            },
            {
                RoomType::TreasureRoom,
                {
                ...
                {
                    {
                        ...
                        MiningEnemyRoomWormsBasic, EnemyRoomSingleMage,
                    },
        ...
        DifficultyRegion::Easy, {
            {
                ...
                {
                    {
                        QuadShooterRoomSmall, MiningEnemyRoomBoulders, MiningEnemyRoomMoles, MiningEnemyRoomLane,
                        MiningEnemyRoomAvenue, MiningEnemyRoomPileDrivers, MiningEnemyRoomBulldozers,
                        MiningEnemyRoomMoles2,
                        MiningEnemyRoomPileDriversIntro, MiningEnemyRoomQuadShooterBoulders, MiningEnemyRoomWormsBasic,
                        MiningEnemyRoomWorms
                    },
        ...
        DifficultyRegion::Intro, {
            ...
            {RoomType::EventRoom, {{EventRoomOven, EventRoomOracleCrab, EventRoomInverter}, {EventRoomOptimizer}}},
            {
                RoomType::TreasureRoom,
                {
                    ...
                    {
                        TreasureRoomSniper, TreasureRoomShotgun, TreasureRoomOstrich, TreasureRoomMachineGun,
                        TreasureRoomSuperSize, TreasureRoomPinBall, TreasureRoomHare, TreasureRoomRisky
                    }
                }
            },
        }
        ...
        DifficultyRegion::Easy, {
            {
                ...
                {
                    {
                        MedicalEnemyRoomHeartBeat, MedicalEnemyRoomHeartBeat2, MedicalEnemyRoomHand,
                        MedicalEnemyRoomSpineWormQuadShooters, MedicalEnemyRoomSyringes, EnemyRoomSingleMage,
        ...
        DifficultyRegion::Medium, {
            {
                ...
                {
                    {
                        MedicalEnemyRoomHeartBeat4, MedicalEnemyRoomHeartBeat2, MedicalEnemyRoomHand,
                        MedicalEnemyRoomChain,
        ...
        DifficultyRegion::Easy, {
            {
                ...
                {
                    {
                        EnemyRoomMagic, MilitaryEnemyRoomTimeLine, HifiEnemyRoomSwarmLasers, HifiRoomShieldedMadness,
                        HifiRoomLaserFiesta, MedicalEnemyRoomHeartBeat3, MedicalEnemyRoomInvincible, EnemyRoomPhantom,
                        EnemyRoomEyes,
        ...
        DifficultyRegion::Medium, {
            {
                ...
                {
                    {
                        HifiRoomShieldedMadness, HifiRoomLaserFiesta, MedicalEnemyRoomHeartBeat3,
                        MedicalEnemyRoomInvincible, MilitaryEnemyRoomTimeLine, EnemyRoomPhantom, EnemyRoomEyes,
                    },
                    bossRooms,
                }
            },
...
inline RoomType getRandomRoomType(bool excludeNone, int roomsTraversed) {
    ...
    if (r < 0.65f) {
        //enemy room has higher chance of being rolled
...
struct weightedRegionEffects {
    ...
    std::vector<std::vector<BulletStackEffect> > getNWeightedEffects(
        int N, std::vector<std::vector<BulletStackEffect> > ignoreList = {}) {
        ...
        for (int j = 0; j < N; j++) {
            float random = static_cast<float>(rand()) / (static_cast<float>(
                               RAND_MAX / tempWeightedEffects.back().second));
            for (int i = 0; i < tempWeightedEffects.size(); i++) {
                if (tempWeightedEffects[i].second > random) {
                    ...
                    float weightToRemove = (tempWeightedEffects[i].second - ((i > 0)
                                                                                 ? tempWeightedEffects[i - 1].second
                                                                                 : 0));
...
inline RoomPreset getRoomPreset(RoomType type, MapRegion currRegion, bool locked, int roomsTraversed = -1,
    ...
    // Regular rooms
        ...
        nextRoom = Random::ListItem(locked
                                        ? getDirectory(currRegion).at(currentRegionDifficulty).at(type).locked
                                        : getDirectory(currRegion).at(currentRegionDifficulty).at(type).unlocked);
    }
    ...
    if (nextRoom.oneTime) {
        for (auto it = map.directory.begin(); it != map.directory.end(); ++it) {
            if (it->first >= currentRegionDifficulty) {
                // Remove from current and future regions
                ...
                unlockedRoomList.erase(std::remove(unlockedRoomList.begin(), unlockedRoomList.end(), nextRoom),
                                       unlockedRoomList.end());
            }
        }
    }

    // Elite
    if ((type == RoomType::EnemyRoom || type == TreasureRoom || type == RestRoom) && roomsTraversed > 6 &&
        Random::Float() < eliteSpawnChance) {
